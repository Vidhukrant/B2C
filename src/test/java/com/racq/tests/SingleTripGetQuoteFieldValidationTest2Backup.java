...
import com.racq.pages.NextPage;

import static org.assertj.core.api.Assertions.*;

import org.openqa.selenium.JavascriptExecutor;

public class SingleTripGetQuoteFieldValidationTest2Backup extends BaseTest {
	GetAQuotePage Page1;
	...
	public void testgetaquote() {
		Page1 = new GetAQuotePage(d);
		Page1.getSingleTripGetQuote("ENGLAND", "23/02/2020", "23", "25", "");

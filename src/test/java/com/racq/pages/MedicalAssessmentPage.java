...
public class MedicalAssessmentPage extends BasePage {
	...
	By againstMedicalAdviceOrMedicalTreatmentNo=By.xpath("(//*[text()=' No '])[1]");
	...
	By awaitingSurgeryTreatmentInvestigationOfProceduresNo =By.xpath("(//*[text()=' No '])[2]");

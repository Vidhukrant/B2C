...
import com.racq.tests.BaseTest;

public class DetailsPage extends BasePage {

	static By primaryFirstName = By.id("userFirstName");
	...
	By addDependent = By.xpath("//*[@class='fa fa-plus-circle pl-3']");
	...
	By confirmAndFinaliseQuote = By.xpath("//*[@data-auto-id='ConfirmBtnText']");
	...
	By detailPageForRACNO = By.xpath("//*[@data-auto-id='preMedicalConditionNo']");
	...
	By primaryFirstNameFieldBlankErrorMessage = By
			.xpath("//*[@data-auto-id='userFirstNameErrorOne']");
	...
	By streetFieldBlankErrorMessage = By.xpath("//*[@data-auto-id='userStreetAddressErrorOne']");
	...
	public void addDependent() {
		...
		// addDependent);
		ScrollForLocator(By.xpath("//h5[text()='Contact Information of Member/Primary Traveller']"));
		waitFor(2);

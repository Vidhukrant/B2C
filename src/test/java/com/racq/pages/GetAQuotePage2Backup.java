...
public class GetAQuotePage2Backup extends BasePage {
	...
	By singleTripSelect = By.xpath("//*[text()=' Single Trip ']");
	...
	By Leaving548daysforbothsingleandamt = By.xpath(
			"//*[text()=' The Departure Date entered is too far in the future.   It must be less than 548 days from today. ']");
	...
	public GetAQuotePage2Backup(WebDriver d) {
		super(d);
		waitForLoader();
		/*
		 * if

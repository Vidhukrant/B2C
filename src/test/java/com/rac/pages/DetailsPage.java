...
public class DetailsPage extends BasePage {
	...
	By secondaryDOB = By.xpath("//*[@id='adTravelerDateOfBirth']");
	...
	By addDependent=By.xpath("//span[text()='Add Dependents']");
	By deleteDependents = By.xpath("(//i)[4]");
	...
	By detailPageYes = By.xpath("//button[@id='preMedicalCondition-button']/div[contains(text(), 'Yes ' )]");
	By detailPageRACYes=By.xpath("(//div[contains(text(),'Yes')])[3]");

	By confirmAndFinaliseQuote = By.xpath("//button[contains(text(),'Confirm your details')]");
	
	By confirmAndFinalizeQuoteRAC=By.xpath("(//button[@type='submit'])[1]");
	
	By detailPageNo = By.xpath("//button[@id='preMedicalCondition-button']/div[contains(text(),'No')]");
	By detailPageForRACNO=By.xpath("(//button[@id='preMedicalCondition-button'])[2]");
	By quoteSummaryEdit = By.xpath("//*[@id='Capa_1']");
	...
	By PDS_Condition=By.xpath("//button[@id='privacyDisclaimerID-button']/div[contains(text(),'Yes')]");
	By Marketing_Consent=By.xpath("//button[@id='marketingConsentCondition-button']/div[contains(text(),'Yes')]");
	...
	By primaryDOBFieldBlankErrorMessage = By.xpath("//*[text()=' Please enter the Date of Birth ']");
	...
	By secondaryDOBFieldBlankErrorMessage = By.xpath("//*[text()=' Please enter the Date of Birth ']");
	...
	By confirmEmailInValidErrorMessage = By.xpath("//*[contains(text(),' Please enter a valid Confirm Email address ')]");
	By confirmEmailmismatchErrorMessage = By
			.xpath("//*[contains(text(),' Confirm Email address does not match with the email Address ')]");
	...
	By primaryDOBAgeBetween18and85ErrorMessage=By.xpath("//*[contains(text(),' Age of Traveller must be between 18-110 ')]");
	By secondaryDOBAgeBetween18and85ErrorMessage=By.xpath("//*[contains(text(),' Age of Traveller must be between 18-110 ')]");
	...
	public void addDependent() {
		//((JavascriptExecutor)d).executeScript("arguments[0].scrollIntoView();", addDependent);
		ScrollForLocator(By.xpath("//h5[text()='Contact information of primary traveller']"));
		waitFor(2);
	...
	public void sendACopyOfQuoteEmail(String sendACpyEmail) {
		...
		waitFor(5);
		Boolean flag=iselementPresent(By.xpath("//span[text()='Something went wrong while calling API. See the log']"));
		if(flag==true)
		{
...
public void validateSecondryLname() {
	...
	public void getPincodeFieldBlank(String pFirstName, String pLastName, String pDOB,
			...
			String confirmEmilAddress, String mblPhoneNo, String depFirstName, String depLastName, String depDOBName) {
		//((JavascriptExecutor)d).executeScript("arguments[0].scrollIntoView();", d.findElement(postCode));
		waitFor(2);
		d.findElement(postCode).click();
		waitFor(2);
	...
	public void getEmailFieldBlank(String pFirstName, String pLastName, String pDOB,
			String sFirstName, String sLastName, String sDOB, String strtAddress, String sburb, String pstCode,
			String confirmEmilAddress, String mblPhoneNo, String depFirstName, String depLastName, String depDOBName) {
		//((JavascriptExecutor)d).executeScript("arguments[0].scrollIntoView();", d.findElement(emailAddress));
		waitFor(2);
		waitFor(5);
		d.findElement(emailAddress).click();
		waitFor(2);
	...
	public void getEmailInValid(String pFirstName, String pLastName, String pDOB,
			String sFirstName, String sLastName, String sDOB, String strtAddress, String sburb, String pstCode,
			String emilAddress) {
		//((JavascriptExecutor)d).executeScript("arguments[0].scrollIntoView();", emailAddress);
		waitFor(2);
		d.findElement(emailAddress).sendKeys(emilAddress);
		waitFor(2);
		d.findElement(confirmEmailAddress).click();
	...
	public void getConfirmEmailFieldBlank(String pFirstName, String pLastName, String pDOB,
		...
		//((JavascriptExecutor)d).executeScript("arguments[0].scrollIntoView();", d.findElement(confirmEmailAddress));
		waitFor(2);
		d.findElement(confirmEmailAddress).click();
		waitFor(2);
	...
	public void getConfirmEmailInValid(String pFirstName, String pLastName, String pDOB,
		...
		//((JavascriptExecutor)d).executeScript("arguments[0].scrollIntoView();", confirmEmilAddress);
		waitFor(2);
		d.findElement(confirmEmailAddress).sendKeys(confirmEmilAddress);
		waitFor(2);
		d.findElement(mobilePhoneNo).click();
	...
	public void getMobileFieldBlank(String pFirstName, String pLastName, String pDOB,
		  ...
		  waitFor(2);
		 // ((JavascriptExecutor)d).executeScript("arguments[0].scrollIntoView();", d.findElement(mobilePhoneNo));
			waitFor(2);
        d.findElement(mobilePhoneNo).click();
        waitFor(2);
        d.findElement(confirmEmailAddress).click();

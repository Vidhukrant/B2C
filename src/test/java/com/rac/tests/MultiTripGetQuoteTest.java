...
public class MultiTripGetQuoteTest extends BaseTest{
	...
	@Test
	public void testAMTtraveldestfieldblankvalidation() throws InterruptedException
	{
		GetAQuotePage Page1=new GetAQuotePage(d);
		Page1.switchToAMTtrip();
        Page1.getTravelDestinationFieldBlank("22/02/2020", "24/02/2020", "21", "25","1");
		assertThat(Page1.gettravelerrormsg().trim().equalsIgnoreCase("Please select the Returning On date"));
		
	}
	
	@Test(priority=1)
	public void testAMTleavingonfieldblankvalidation() throws InterruptedException
	{
		GetAQuotePage Page1=new GetAQuotePage(d);
		Page1.switchToAMTtrip();
	...
	@Test
	public void test_leavingandretruningdatesame() throws InterruptedException
	{
		GetAQuotePage Page1=new GetAQuotePage(d);
		Page1.switchToAMTtrip();
        Page1.getleavingandreturndateAMT("ENGLAND","22/01/2021","22/01/2021","23","21","1");
		assertThat(Page1.getAMTleaveandreturnerrormsg().trim().equalsIgnoreCase("Return Date cannot be the same as Leaving on Date."));
    }

	@Test
	public void test_ageprimaryagefieldblankvalidation() throws InterruptedException
	{
		GetAQuotePage Page1=new GetAQuotePage(d);
		Page1.switchToAMTtrip();
	...
	@Test
	public void test_AMTtraveller_agebelow18andmore75() throws InterruptedException
	{
		GetAQuotePage Page1=new GetAQuotePage(d);
		Page1.switchToAMTtrip();
	...
	public void test_pastdate()
	{
		...
		assertThat(Page1.getpastdateerrormsg().trim().equalsIgnoreCase("Leaving On date cannot be date before the current date"));
	}                                                                   
	...
	public void test_amtannualtrip_leavingdate_548days()
	{
		...
		assertThat(Page1.getsingletrip_leavingdate_548dayserrormsg().trim().equalsIgnoreCase("Leaving Date can not be greater than 548 days. "));
	}
	...
	public void test_annualamtreturningdate_60days()
	{
		...
		assertThat(Page1.getAMTtrip60daysfromdeparterrormsg().trim().equalsIgnoreCase("Returning On date must be less than or equal to 60 days from the Leaving On date."));
	}

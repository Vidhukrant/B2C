...
public class DetailPageFieldValidationTest extends BaseTest {
  ...
  @Test(description = "Blank field validation For Primary Traveller Last Name ",priority=2)
    ...
    public void testForInvalidConFirmEmailFormat() throws InterruptedException {
        ...
        assertThat(Page3.getConfirmEmailInValidErrorMsg().trim().equalsIgnoreCase("Please enter a valid Confirm Email address"));
        Page3.page3Reset();
    }
    ...
    public void testForMisMatchOfEmailAndConfirmEmail() throws InterruptedException {
        ...
        assertThat(Page3.getEmailMismatchErrorMsg().trim().equalsIgnoreCase("Confirm Email address does not match with the email Address"));
        Page3.page3Reset();
    }
...
*/
    ...
    public void getPrimaryAgeDetails18to85SkiWinterSPorts() {
        ...
        assertThat(Page3.getPrimaryAgeBetween18and85ErrorMsg().equalsIgnoreCase("Age of Traveller must be between 18-110"));
        Page3.page3Reset();
    }
    ...
    public void getSecondaryAgeDetails18to85SkiWinterSPorts() {
        ...
        assertThat(Page3.getSecondaryAgeBetween18and85ErrorMsg().equalsIgnoreCase("Age of Traveller must be between 18-110"));
        Page3.page3Reset();
    }

...
public class MedicalAssessmentPage extends BasePage {
	...
	By againstMedicalAdviceOrMedicalTreatmentNo=By.xpath("//*[contains(text(),'Are you/this person travelling against medical advice or for medical treatment?')]//..//..//mat-button-toggle-group[1]//mat-button-toggle[2]//button[1]//div[1]");
	...
	By awaitingSurgeryTreatmentInvestigationOfProceduresNo =By.xpath("//*[contains(text(),' Are you/this person currently awaiting surgery, treatment, investigation of procedures?')]//..//..//mat-button-toggle-group[1]//mat-button-toggle[2]//button[1]//div[1]");
	...
	By option3No=By.xpath("//*[contains(text(),'Have you/this person ever or currently have any condition that involves your heart, brain, circulatory system/blood vessels, your lung or respiratory conditions, any type of cancer, or any Mental Illness, reasonably known to you, for which treatment, medication, surgery or advice has been received or prescribed by a medical practitioner or health professional prior to your purchase of this policy?')]//..//..//mat-button-toggle-group[1]//mat-button-toggle[2]//button[1]//div[1]");
	
	
	By modalCancel=By.xpath("//div[@class='close-btn-wrap']//span[contains(text(),'×')]");
	
	By option4Yes=By.xpath("//*[contains(text(),' Do you/this person understand that any medical condition not declared will result in having no cover for any claim exacerbated by, arising from or related to that medical condition? ')]//..//..//mat-button-toggle-group[1]//mat-button-toggle[1]//button[1]//div[1]");

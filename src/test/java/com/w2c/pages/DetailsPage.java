...
public class DetailsPage extends BasePage {
	...
	By primaryLastNameFieldBlankErrorMessage = By
			.xpath("//*[@data-auto-id='userLastNameErrorOne']");
	...
	By secondaryFirstNameFieldBlankErrorMessage = By
			.xpath("//*[@data-auto-id='adUserFirstNameErrorOne']");
	By secondaryLastNameFieldBlankErrorMessage = By
			.xpath("//*[@data-auto-id='adUserLastNameErrorOne']");
	...
	By confirmEmailInValidErrorMessage = By
			.xpath("//*[contains(text(),' Please enter a valid Confirm Email address ')]");
	By confirmEmailmismatchErrorMessage = By
			.xpath("//*[@data-auto-id='userConfirmEmailAddressErrorThree']");
	...
	By primaryDOBAgeBetween18and85ErrorMessage = By
			.xpath("//*[@data-auto-id='PrimaryTravelerDateOfBirthErrorFour']");
	By secondaryDOBAgeBetween18and85ErrorMessage = By
			.xpath("//*[@data-auto-id='adTravelerDateOfBirthErrorThree']");
	...
	public void validateDOB() {
		...
		ScrollForLocator(By.xpath("//h5[text()='Primary Traveller']"));
		waitFor(2);

...
public class GetAQuotePage extends BasePage {
	...
	By annualMultiTrip = By.id("mlttrip");
	...
	// "//*[contains(text(),' We can not complete your request. You cannot mix
	// Domestic and International travel on a single policy. AUSTRALIA,LORD HOWE
	// ISLAND,NORFOLK ISLAND AUSTRALIA,LORD HOWE ISLAND,NORFOLK ISLAND')]");
	...
	By LeavingDate = By.xpath("//*[contains(text(),'Please select the Leaving On date')]");
	By ReturnDate = By.xpath("//*[contains(text(),'Please select the Returning On date')]");
	By leavingandReturnsamedate = By.xpath("//*[@data-auto-id='returnDateErrorTwo']");
	By PrimaryAge = By.xpath("//*[text()=' Please enter the age of the Primary Traveller ']");
	By SingleTripAgeBelow18and110Year = By.xpath("//*[text()=' Age1 of Traveller must be between 18-110 ']");
	By departureDateMoreErrorMsg = By
			.xpath("//*[contains(text(),'Leaving On date cannot be date before current date')]");
	...
	By singletripretutndate365days = By
			.xpath("//*[contains(text(),'Returning On date cannot be more than 365 days from Leaving On date')]");
	...
	By AMTAgebelow18and75year = By
			.xpath("//*[contains(text(), 'Travellers age must be less than or equal to 75.')]");
	By AMTretrundate60days = By.xpath("//*[@data-auto-id='returnDateErrorFive']");
	...
	public GetAQuotePage(WebDriver d) {
		...
		waitForLoader();
		/*
		 * if (d.findElement(pageHeading).getText().contains("Travel Insurance")) {
	...
	public void switchToAMTtrip() {
		((JavascriptExecutor) d).executeScript("arguments[0].click();", d.findElement(annualMultiTrip));
	...
	public void getageAMTtraveller_agebelow18andmore75(String traveldestination, String leavingOn, String returningOn,
		...
		d.findElement(NoofDependants).sendKeys(noofDependants);
		// d.findElement(State).click();
		// ((JavascriptExecutor)d).executeScript("arguments[0].click();",d.findElement(state_click));
		d.findElement(Getaquote).click();
